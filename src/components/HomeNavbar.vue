<template>
  <div class="container">
    <router-link to="/addbook"><BaseButton>Add book</BaseButton></router-link>
    <router-link to="/readbooks"
      ><BaseButton>Read books</BaseButton></router-link
    >
    <router-link to="/randombook"
      ><BaseButton>Random book</BaseButton></router-link
    >
